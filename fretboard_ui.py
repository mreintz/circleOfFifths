...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.nutButton = QLineEditTabReact(self.centralwidget)
        self.nutButton.setMinimumSize(QtCore.QSize(40, 40))
        self.nutButton.setMaximumSize(QtCore.QSize(40, 16777215))
        self.nutButton.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.scaleOrChordSelector = QtWidgets.QComboBox(self.centralwidget)
        self.scaleOrChordSelector.setObjectName("scaleOrChordSelector")
        self.horizontalLayout_3.addWidget(self.scaleOrChordSelector)
